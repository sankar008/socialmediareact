        ...
        <div className="progress-wrap">
          ...
          <div
            ...
            className={`dot is-first ${
              props.stage === 0 ? isCurrent : isActive
            }`}
          >
            <Smile />
          </div>
          <div
            ...
            className={`dot is-second ${
              props.stage === 1 ? isCurrent : props.stage < 1 ? `` : isActive
            }`}
          >
            <User />
          </div>
          <div
            ...
            className={`dot is-third  ${
              props.stage === 2 ? isCurrent : props.stage < 2 ? `` : isActive
            }`}
          >
            <Image />
          </div>
          <div
            ...
            className={`dot is-fourth  ${
              props.stage === 3 ? isCurrent : props.stage < 3 ? `` : isActive
            }`}
          >
            <Lock />
          </div>
          <div
            ...
            className={`dot is-fifth  ${
              props.stage === 4 ? isCurrent : props.stage < 4 ? `` : isActive
            }`}
          >
            <Flag />
          </div>
