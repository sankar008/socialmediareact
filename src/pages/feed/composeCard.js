...
import {
    Bell, Camera, ChevronDown, ChevronRight, Edit2, Globe, Image, Link2, Lock, MapPin, MoreHorizontal, MoreVertical, Plus, Search, Smile, Tag, User,
    Users, Video,
    X
} from 'react-feather';
import emoji1 from '../../assets/img/icons/emoji/emoji-1.svg';
import mood from '../../data/api/activities/mood/mood-autocpl.json';
import { VideoModal } from './modals/videos';
                ...
                <div className="tab-content" >
                    <div className="compose">
                        <div className="compose-form">
                            <img src="https://xsgames.co/randomusers/avatar.php?g=male" data-demo-src="assets/img/avatars/jenna.png" alt="" />
                        ...
                        <div id="tag-suboption" className={`is-autocomplete is-suboption ${autoComp === 1 ? '' : 'is-hidden'}`}>
                        ...
                        <div id="activities-suboption" className={`is-autocomplete is-suboption ${autoComp === 2 ? '' : 'is-hidden'}`}>
                            ...
                            <div id="mood-autocpl-wrapper" className={`is-autocomplete is-suboption ${autoComp === 3 ? '' : 'is-hidden'}`}>
                            ...
                            <div id="eating-autocpl-wrapper" className={`is-autocomplete is-suboption ${autoComp === 5 ? '' : 'is-hidden'}`}>
                                <div className="control has-margin">
                            ...
                            <div id="reading-autocpl-wrapper" className={`is-autocomplete is-suboption ${autoComp === 6 ? '' : 'is-hidden'}`}>
                                <div className="control has-margin">
                            ...
                            <div id="watching-autocpl-wrapper" className={`is-autocomplete is-suboption ${autoComp === 7 ? '' : 'is-hidden'}`}>
                                <div className="control has-margin">
                            ...
                            <div id="travel-autocpl-wrapper" className={`is-autocomplete is-suboption ${autoComp === 8 ? '' : 'is-hidden'}`}>
                                <div className="control has-margin">
                        ...
                        <div id="location-suboption" className={`is-autocomplete is-suboption ${autoComp === 9 ? '' : 'is-hidden'}`}>
                        ...
                        <div id="link-suboption" className={`is-autocomplete is-suboption ${autoComp === 10 ? '' : 'is-hidden'}`}>
                        ...
                        <div id="gif-suboption" className={`is-autocomplete is-suboption ${autoComp === 11 ? '' : 'is-hidden'}`}>
                    ...
                    <div id="extended-options" className={`compose-options ${extended ? '' : 'is-hidden'}`}>
                        <div className="columns is-multiline is-full">
                            ...
                            <div className="column is-6 is-narrower" onClick={() => setAutoComp(1)}>
                            ...
                            <div className="column is-6 is-narrower" onClick={() => setAutoComp(9)}>
                            ...
                            <div className="column is-6 is-narrower" onClick={() => setAutoComp(10)}>
                            ...
                            <div className="column is-6 is-narrower" onClick={() => setAutoComp(11)}>
                    ...
                    <div id="basic-options" onClick={openModal} className={`compose-options ${!extended ? '' : 'is-hidden'}`}>
                        ...
                        <div id="show-activities" className="compose-option" onClick={() => setAutoComp(2)}>
                            <img src={emoji1} alt="" />
                            <span>Activity</span>
                        </div>

                        <div id="open-extended-options" className="compose-option" onClick={setExtended}>
                            <MoreHorizontal />
                        </div>
                    </div>
                        ...
                        <div className={`friends-list ${showFriends ? '' : 'is-hidden'}`}>
                            ...
                            <div className="list-body">
                                ...
                                <div className="friend-block">
                                    ...
                                    <img className="friend-avatar" src="https://xsgames.co/randomusers/avatar.php?g=male" data-demo-src="assets/img/avatars/dan.jpg" alt="" />
                                ...
                                <div className="friend-block">
                                    ...
                                    <img className="friend-avatar" src="https://xsgames.co/randomusers/avatar.php?g=male" data-demo-src="assets/img/avatars/daniel.jpg" alt="" />
                                ...
                                <div className="friend-block">
                                    ...
                                    <img className="friend-avatar" src="https://xsgames.co/randomusers/avatar.php?g=male" data-demo-src="assets/img/avatars/stella.jpg" alt="" />
                                ...
                                <div className="friend-block">
                                    ...
                                    <img className="friend-avatar" src="https://xsgames.co/randomusers/avatar.php?g=male" data-demo-src="assets/img/avatars/david.jpg" alt="" />
                                ...
                                <div className="friend-block">
                                    ...
                                    <img className="friend-avatar" src="https://xsgames.co/randomusers/avatar.php?g=male" data-demo-src="assets/img/avatars/nelly.png" alt="" />
